            ...
            <View>
                <View style={{ flexDirection: "row", width: "100%", justifyContent: "space-between" }} >
                    ...
                    <TouchableOpacity onPress={() => deleteClass(index)} >
                        <Text style={{ color: Theme.red, fontSize: 18, fontWeight: "600", marginTop: 20, marginRight: 5 }} >
                            Delete
                        </Text>
                    </TouchableOpacity>
            ...
            <View style={{ padding: 20, flex: 1 }} >
                <ScrollView>
                    ...
                    <View style={{ width: "100%", alignItems: "center", marginTop: 20, marginBottom: 60 }} >
                        <TouchableOpacity onPress={() => addClass()} style={{ backgroundColor: Theme.gray, padding: 15, borderRadius: 10, width: "100%" }} >
